...
const ProfilePage = () => {
  const favoriteThings = [
    { category: '好きな食べ物', items: ['ラーメン', 'カレー', 'お寿司'] },
    { category: '好きなゲーム', items: ['ドラクエ', 'FF', 'ポケモン'] },
        ...
        <div style={{ padding: '10px', fontSize: '12px' }}>
          <ul style={{ listStyle: 'none' }}>
            <li style={{ marginBottom: '5px' }}>
              <span style={{ color: '#ff6600' }}>▶</span> フレームワーク: React + Vite
            </li>
            <li style={{ marginBottom: '5px' }}>
              <span style={{ color: '#ff6600' }}>▶</span> ルーティング: React Router
            </li>
            <li style={{ marginBottom: '5px' }}>
              <span style={{ color: '#ff6600' }}>▶</span> ホスティング: Cloudflare Pages
            </li>
            <li style={{ marginBottom: '5px' }}>
              <span style={{ color: '#ff6600' }}>▶</span> デザイン: 自作CSS（レガシー風）
            </li>
          </ul>
          <p style={{ marginTop: '15px', color: '#999999' }}>
            ※ 1999年当時は「メモ帳」でHTMLを書いていました（笑）
          </p>
        </div>
      </div>
    </div>
